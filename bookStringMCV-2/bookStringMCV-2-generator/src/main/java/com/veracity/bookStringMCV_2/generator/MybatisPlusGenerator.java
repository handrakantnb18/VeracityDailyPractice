package com.veracity.bookStringMCV_2.generator;
...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "com.veracity.bookStringMCV_2";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/bookStringMCV-2-model"),
        mapper("/bookStringMCV-2-dao"),
        mapperxml("/bookStringMCV-2-web"),
        service("/bookStringMCV-2-service"),
        web("/bookStringMCV-2-web"),
        ;
